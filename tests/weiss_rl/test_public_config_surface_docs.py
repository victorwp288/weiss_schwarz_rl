...
PUBLIC_DOCS = (
    ...
    REPO_ROOT / "docs" / "concepts" / "artifacts.md",
    REPO_ROOT / "docs" / "concepts" / "architecture.md",
    REPO_ROOT / "docs" / "concepts" / "evaluation.md",
    REPO_ROOT / "docs" / "concepts" / "model.md",
    REPO_ROOT / "docs" / "concepts" / "rewards.md",
    REPO_ROOT / "docs" / "concepts" / "training.md",
    REPO_ROOT / "docs" / "deployment" / "human_play.md",
    REPO_ROOT / "docs" / "operations" / "thesis_workflow.md",
    REPO_ROOT / "runs" / "README.md",
    REPO_ROOT / "tests" / "README.md",
    REPO_ROOT / "deploy" / "human-play-api" / "README.md",
    REPO_ROOT / "web" / "human-play" / "README.md",
)
