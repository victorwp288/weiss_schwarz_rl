...
RUN_LABEL="${RUN_LABEL:-thesis_main_candidate_v9b_anchor_push_relaxed_gate_cf81_20260429}"
MAX_UPDATES="${MAX_UPDATES:-320}"
STACK_CONFIG="${STACK_CONFIG:-configs/main_impala_league_server_v9b_anchor_push_relaxed_gate.yaml}"
