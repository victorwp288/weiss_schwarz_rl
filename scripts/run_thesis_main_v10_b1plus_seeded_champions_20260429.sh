...
RUN_LABEL="${RUN_LABEL:-thesis_main_candidate_v10_b1plus_seeded_champions_cf81_20260429}"
MAX_UPDATES="${MAX_UPDATES:-460}"
STACK_CONFIG="${STACK_CONFIG:-configs/main_impala_league_server_v10_b1plus_seeded_champions.yaml}"
