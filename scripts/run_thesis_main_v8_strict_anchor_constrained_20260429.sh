...
RUN_LABEL="${RUN_LABEL:-thesis_main_candidate_v8_strict_anchor_constrained_cf81_20260429}"
MAX_UPDATES="${MAX_UPDATES:-500}"
STACK_CONFIG="${STACK_CONFIG:-configs/main_impala_league_server_v8_strict_anchor_constrained.yaml}"
