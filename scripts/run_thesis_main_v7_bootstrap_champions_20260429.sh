...
RUN_LABEL="${RUN_LABEL:-thesis_main_candidate_v7_bootstrap_champions_cf81_20260429}"
MAX_UPDATES="${MAX_UPDATES:-400}"
STACK_CONFIG="${STACK_CONFIG:-configs/main_impala_league_server_v7_bootstrap_champions.yaml}"
