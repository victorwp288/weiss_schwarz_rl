...
RUN_LABEL="${RUN_LABEL:-thesis_main_candidate_v11_lowdamage_b1plus_cf81_20260429}"
MAX_UPDATES="${MAX_UPDATES:-400}"
STACK_CONFIG="${STACK_CONFIG:-configs/main_impala_league_server_v11_lowdamage_b1plus.yaml}"
