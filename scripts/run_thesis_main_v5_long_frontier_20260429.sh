...
RUN_LABEL="${RUN_LABEL:-thesis_main_candidate_v5_long_frontier_es_cf81_20260429}"
MAX_UPDATES="${MAX_UPDATES:-800}"
STACK_CONFIG="${STACK_CONFIG:-configs/main_impala_league_server_v5_long_frontier.yaml}"
