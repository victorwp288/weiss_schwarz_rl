...
RUN_LABEL="${RUN_LABEL:-thesis_main_candidate_v13_b1init_long_variant_cf81_20260430}"
MAX_UPDATES="${MAX_UPDATES:-560}"
STACK_CONFIG="${STACK_CONFIG:-configs/main_impala_league_server_v13_b1init_long_variant.yaml}"
