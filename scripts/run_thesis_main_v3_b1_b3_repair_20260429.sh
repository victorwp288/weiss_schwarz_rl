...
RUN_LABEL="${RUN_LABEL:-thesis_main_candidate_v3_b1_b3_repair_cf81_20260429}"
MAX_UPDATES="${MAX_UPDATES:-140}"
STACK_CONFIG="${STACK_CONFIG:-configs/main_impala_league_server_v3_b1_b3_repair.yaml}"
