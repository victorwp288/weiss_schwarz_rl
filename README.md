...
- `runs/`: local output root for generated manifests, checkpoints, replay bundles, and figures. Raw research artifacts are not tracked on public `main`.
- `thesis_figures_final/`: compact public figure exports.
...
Before changing risky code, read [CONTRIBUTING.md](CONTRIBUTING.md) and the workflow docs under [docs/](docs/). Keep public script paths compatible and include validation commands in any substantive change notes.
