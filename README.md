...
- `python/scripts/make_figures.py` still writes placeholder artifacts, and it can now render a clearly-labeled **toy/demo figure bundle** from public-demo final-eval artifacts.
