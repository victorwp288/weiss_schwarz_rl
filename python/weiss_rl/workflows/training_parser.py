...
from weiss_rl.workflows.training_parser_arguments import (
...
def add_training_parsers(
    ...
    add_train_b1_guided_seed_parser(subparsers, add_common)
    add_train_main_parser(subparsers, add_common)
    add_train_main_guided_bootstrap_parser(subparsers, add_common)
