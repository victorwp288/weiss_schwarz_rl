...
def build_canonical_eval_evidence_summary(inputs: RunLevelReportUpdateInputs) -> dict[str, Any]:
    layout = inputs.layout
    summary_sections = inputs.final_eval_payload.get("summary_sections", [])
    section_keys = [
        str(section["key"])
    ...
    return {
        "final_eval_summary_path": layout.relative(layout.final_eval_summary_json()),
        "policy_set_path": layout.relative(layout.final_eval_policy_set_json()),
        "matchups_path": layout.relative(layout.final_eval_matchups_csv()),
        "mean_matrix_path": layout.relative(layout.final_eval_matrix_csv("mean")),
        "paper_readiness_summary_path": layout.relative(layout.paper_readiness_summary_path),
        "policy_count": len(inputs.policy_ids),
        ...
        "selection_status": inputs.selection_details.get("status", "unknown"),
        "summary_section_keys": section_keys,
...
def build_run_summary_update_fields(inputs: RunLevelReportUpdateInputs) -> dict[str, Any]:
    ...
    return {
        ...
        "canonical_eval_evidence": build_canonical_eval_evidence_summary(inputs),
    }
