...
from weiss_rl.models.actions.candidate_partitioning import partition_candidate_family_masks
...
class StructuredDenseScoringMixin:
    ...
    def _score_candidates(
        ...
        *,
        ...
        family_masks = partition_candidate_family_masks(
            family_ids,
        ...
        attack_mask = family_masks.attack
        ...
        default_mask = family_masks.default
