...
class ImpalaPublicHeuristicSupportMixin:
    def _score_public_teacher_target_logits(
        self: Any,
        *,
        forward_model: Any,
        obs_rows: Tensor,
        ...
        return score_public_teacher_target_logits(
    ...
    def _score_public_heuristic_target_logits(
        ...
        **kwargs: Any,
        ...
        return self._score_public_teacher_target_logits(**kwargs)
    ...
    def _packed_public_heuristic_target_logits(
        ...
        *,
        ...
        if int(active_rows.shape[0]) == total_rows:
            ...
            return self._score_public_teacher_target_logits(
                forward_model=forward_model,
                obs_rows=flat_obs,
                legal_actions=legal_actions,
                observation_context=observation_context,
        ...
        subset_target_logits = self._score_public_teacher_target_logits(
            forward_model=forward_model,
            obs_rows=subset_obs,
