...
from weiss_rl.artifact_contract import (
    build_run_directory_audit as build_artifact_contract_run_directory_audit,
)
from weiss_rl.artifacts import ArtifactLayout
from weiss_rl.eval.paper_contracts import (
    build_final_eval_artifact_contract as _build_final_eval_artifact_contract,
)
from weiss_rl.eval.paper_contracts import build_manifest_contract as _build_manifest_contract
...
def _build_run_directory_audit(run_dir: Path) -> dict[str, Any]:
    return dict(build_artifact_contract_run_directory_audit(run_dir))
