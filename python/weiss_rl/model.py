...
class PolicyValueModel(nn.Module):
    ...
    def initial_hidden(
        ...
        *,
        ...
        parameter = self.policy_head.weight
        hidden_device = parameter.device if device is None else device
        hidden_dtype = parameter.dtype if dtype is None else dtype
...
__all__ = ["GLOBAL_ACTION_SPACE_SIZE", "ModelConfig", "PolicyValueModel"]
