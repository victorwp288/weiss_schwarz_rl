...
def test_checkpoint_interpolation_entrypoint_facade_reexports_cli_runtime_and_core_helpers() -> None:
    from weiss_rl.training import (
        checkpoint_interpolation,
        checkpoint_interpolation_cli,
        checkpoint_interpolation_entrypoint,
        checkpoint_interpolation_runtime,
    )

    assert checkpoint_interpolation_entrypoint._build_parser is (
        checkpoint_interpolation_cli.build_checkpoint_interpolation_parser
    )
    assert checkpoint_interpolation_entrypoint.run_checkpoint_interpolation is (
        checkpoint_interpolation_runtime.run_checkpoint_interpolation
    )
    assert checkpoint_interpolation_entrypoint.interpolate_model_state_dicts is (
        checkpoint_interpolation.interpolate_model_state_dicts
    )
    assert checkpoint_interpolation_entrypoint._load_checkpoint is checkpoint_interpolation_runtime.load_checkpoint
    assert checkpoint_interpolation_entrypoint._model_state_dict is checkpoint_interpolation_runtime.model_state_dict
    assert checkpoint_interpolation_entrypoint._validate_checkpoint_contracts is (
        checkpoint_interpolation_runtime.validate_checkpoint_contracts
    )
    assert checkpoint_interpolation_entrypoint._copy_contract_artifacts is (
        checkpoint_interpolation_runtime.copy_contract_artifacts
    )
    assert checkpoint_interpolation_entrypoint._publish_snapshot is (
        checkpoint_interpolation_runtime.publish_interpolated_snapshot
    )
    assert checkpoint_interpolation_entrypoint._sha256_file is checkpoint_interpolation_runtime.sha256_file
