...
from weiss_rl.workflows import eval_parser, eval_parser_arguments, eval_parser_validation


def test_eval_parser_facade_reexports_split_module_owners() -> None:
    assert eval_parser.add_eval_common_arguments is eval_parser_arguments.add_eval_common_arguments
    assert eval_parser.add_public_demo_arguments is eval_parser_arguments.add_public_demo_arguments
    assert eval_parser.add_canonical_eval_arguments is eval_parser_arguments.add_canonical_eval_arguments
    assert eval_parser.add_summary_only_arguments is eval_parser_arguments.add_summary_only_arguments
    assert eval_parser._resolve_run_label is eval_parser_validation._resolve_run_label
    assert eval_parser._require_positive_int is eval_parser_validation._require_positive_int
