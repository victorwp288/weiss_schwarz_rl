...
def test_make_figures_entrypoint_reexports_figure_mode_helpers() -> None:
    from weiss_rl.workflows.figures import figure_modes, figures_entrypoint

    assert figures_entrypoint.run_public_demo_figure_mode is figure_modes.run_public_demo_figure_mode
    assert figures_entrypoint.run_placeholder_figure_mode is figure_modes.run_placeholder_figure_mode
    assert figures_entrypoint.run_paper_figure_mode is figure_modes.run_paper_figure_mode
