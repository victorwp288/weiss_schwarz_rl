...
from weiss_rl.runtime_components.logging import process_debug_log
from weiss_rl.runtime_components.shared import (
    open_shared_collector_slot,
    shared_unroll_metadata,
    write_unroll_to_shared_slot,
)
from weiss_rl.runtime_components.shared_transport import (
    create_shared_collector_slot_config,
)
from weiss_rl.runtime_components.shared_transport import (
    open_shared_collector_slot as open_runtime_shared_collector_slot,
)
    ...
    if runtime._use_shared_collector_transport:
        ...
        for actor_id in range(int(runtime.config.actor_count)):
            ...
            for slot_id in range(slot_count):
                ...
                actor_slots.append(open_runtime_shared_collector_slot(slot_config, create=True))
