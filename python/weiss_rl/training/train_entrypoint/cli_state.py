"""Resolve CLI arguments into the training run state."""

from __future__ import annotations

from typing import Any, cast

from weiss_rl.training.train_entrypoint.state import TrainCliState
...
__all__ = ["require_explicit_resume_geometry", "resolve_train_cli_state"]
